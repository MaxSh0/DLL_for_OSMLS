...
namespace Module1
{
    public class TestModule : OSMLSModule
    {
        ...
        protected override void Initialize()
        {
           ...
           // airplanes = CreateAirplanes();
           // for (int i = 0; i < 20; i++)
           // {
            //    coordinateDepAir[i] = airplanes[i].coordinateDepartureAirplane;
            //}
        ...
        public Airplane CreateAirplane(Coordinate coordinateAirport)
        {
            ...
            do
            {
                int rndForCoordinate = rnd.Next(1, 5);
            ...
            //airplane.line = new LineString(lineCoordinates);
           // MapObjects.Add(airplane.line);
            ...
            do
            {
                ...
                switch (rndForCoordinate)
                {
                    case 1:
                        ...
                        //coordinateIntermediate = new Coordinate()
                        break;
                    case 2:
        ...
        public Coordinate RandomCoordinateArrival(Coordinate coordinateDeparture)
        {
            Random rnd = new Random();
            Coordinate coordinateArrival = new Coordinate(0, 0);
            int rndForCoordinate;
            do
            {
                rndForCoordinate = rnd.Next(1, 5);
                switch (rndForCoordinate)
                {
                    case 1:
                        coordinateArrival = MathExtensions.LatLonToSpherMerc(-34.831747, -56.020034);
        ...
        public override void Update(long elapsedMilliseconds)
        {
            ...
            //   airplanes[i].straight_line_equation(coordinateDepAir[i], airplanes[i].coordinateArrivalAirplane);
            // }
            ...
            ship1.straight_line_equation(CoordinateDepShip1, ship1.coordinateArrivalShip);
            ship2.straight_line_equation(CoordinateDepShip2, ship2.coordinateArrivalShip);
            ship3.straight_line_equation(CoordinateDepShip3, ship3.coordinateArrivalShip);
            ship4.straight_line_equation(CoordinateDepShip4, ship4.coordinateArrivalShip);
            ship5.straight_line_equation(CoordinateDepShip5, ship5.coordinateArrivalShip);
            ...
            if (airplane1.reached)
            {
                ...
                //MapObjects.Get<LineString>().
                airplane1.coordinateArrivalAirplane = RandomCoordinateArrival(airplane1.coordinateArrivalAirplane);
                //airplane1.line.Coordinates
                //var lineCoordinates = new Coordinate[] { airplane1.coordinateDepartureAirplane, airplane1.coordinateArrivalAirplane };
            ...
            if (airplane2.reached)
            {
                ...
                //airplane2 = CreateAirplane(CoordinateDep2);
                


                airplane2.coordinateArrivalAirplane = RandomCoordinateArrival(airplane2.coordinateArrivalAirplane);
                //airplane1.line.Coordinates
                //var lineCoordinates = new Coordinate[] { airplane2.coordinateDepartureAirplane, airplane2.coordinateArrivalAirplane };
                //airplane2.line = new LineString(lineCoordinates);
            ...
            if (airplane3.reached)
            {
                ...
                airplane3.coordinateArrivalAirplane = RandomCoordinateArrival(airplane3.coordinateArrivalAirplane);
                //airplane1.line.Coordinates
                //var lineCoordinates = new Coordinate[] { airplane3.coordinateDepartureAirplane, airplane3.coordinateArrivalAirplane };
                //airplane3.line = new LineString(lineCoordinates);
            ...
            if (airplane4.reached)
            {
                ...
                airplane4.coordinateArrivalAirplane = RandomCoordinateArrival(airplane4.coordinateArrivalAirplane);
                //airplane1.line.Coordinates
                //var lineCoordinates = new Coordinate[] { airplane4.coordinateDepartureAirplane, airplane4.coordinateArrivalAirplane };
                //airplane4.line = new LineString(lineCoordinates);
            ...
            if (airplane5.reached)
            {
                ...
                airplane5.coordinateArrivalAirplane = RandomCoordinateArrival(airplane5.coordinateArrivalAirplane);
                //airplane1.line.Coordinates
                //var lineCoordinates = new Coordinate[] { airplane5.coordinateDepartureAirplane, airplane5.coordinateArrivalAirplane };
                //airplane5.line = new LineString(lineCoordinates);
    ...
    public class Airplane : Point // Унаследуем данный данный класс от стандартной точки.
    {
        ...
        public Coordinate coordinateArrivalAirplane;
        public Coordinate coordinateDepartureAirplane;
       // public LineString line;
        ...
        public void straight_line_equation(Coordinate coordinate, Coordinate coordinateArrival)
        {
            ...
            if (Y < coordinateArrival.Y + 2000 && X < coordinateArrival.X + 2000 && Y < coordinateArrival.Y + 2000 && X > coordinateArrival.X - 2000 && Y > coordinateArrival.Y - 2000 && X > coordinateArrival.X - 2000 && Y > coordinateArrival.Y - 2000 && X < coordinateArrival.X + 2000)
            {
                reached = true;
            }
        }
    ...
    {
        public bool reached = true; //показыает достиг ли самолет точки назначения
        public bool reacheIntermediate = false;
        public double Speed { get; }
        public Coordinate coordinateArrivalShip;
        public Coordinate coordinateIntermediate;
        public Coordinate coordinateDepartureShip;
        // public LineString line;
